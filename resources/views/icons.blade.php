    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12 grid-margin">
                <div class="card ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">New Icons</h4>
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Web Application Icons</h4>
                        <div class="icons-list row">
                            <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">File Type Icons</h4>
                        <div class="icons-list row">
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <i class="fa fa-adjust"></i>fa-adjust
                            </div>
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Spinner icons</h4>
                        <div class="alert alert-success mb-4">
                            These icons work great with the
                            <code>fa-spin</code> class. Check out the
                            <a href="http://fontawesome.io/examples/#animated" class="alert-link">spinning icons
                                example</a>.
                        </div>
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Form Control Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <i class="fa fa-check-square"></i>fa-check-square
                            </div>
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Currency Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Text Editor Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Directional Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Video Player Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <i class="fa fa-arrows-alt"></i>fa-arrows-alt
                            </div>
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Brand Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="col-lg-12 grid-margin">
                <div class="ibox">
                    <div class="ibox-body">
                        <h4 class="ibox-title">Medical Icons</h4>
                        <div class="row icons-list">
                            <div class="col-sm-6 col-md-4 col-lg-3">
